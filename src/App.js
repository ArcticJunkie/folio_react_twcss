...
function App() {
  return (
    <div className="App bg-white">
      ...
      <main className="flex justify-between space-x-8 px-8 py-10 md:px-52 md:py-20 bg-yellow-100 text-gray-800 text-xl font-poppins">
