...
function Intro() {
    ...
    return (
        <div className="">
            <main ref={ref} style={{ opacity: inView ? 1 : 0 }} className="h-96 flex flex-col space-y-20 px-8 pt-16 xl:px-52 xl:pt-32 text-[#16001E] text-xl font-poppins transition-all duration-1000 ease-in">
                <div className="flex justify-between flex-col space-y-6 xl:space-y-8">
                    <div className="flex flex-col space-y-10">
                        <div className="flex flex-col space-y-20 font-light">
                            ...
                            <h1 className=" leading-relaxed text-2xl xl:text-4xl">I  {' '}
