        ...
        <div className="Nav text-gray-800 ">
            <nav className="bg-gray-50 flex flex-row items-center justify-between px-8 pt-10 xl:px-52 xl:pt-16">
                ...
                <ul className="flex flex-row items-center justify-evenly space-x-8 xl:space-x-12 text-gray-600 text-2xl md:text-3xl ">
                    <li className=""><a href="https://www.linkedin.com/in/nav-verma/" className="hover:text-blue-700 transition-colors duration-300 ease-in-out" target="_blank"><i className="fab fa-linkedin"></i></a></li>
                    <li className=""><a href="https://dribbble.com/navs-dribbble" className="hover:text-blue-700 transition-colors duration-300 ease-in-out" target="_blank"><i className="fab fa-dribbble-square"></i></a></li>
                    <li className=""><a href="https://github.com/navs-github" className="hover:text-blue-700 transition-colors duration-300 ease-in-out" target="_blank"><i className="fab fa-github-square"></i></a></li>
                </ul>
            </nav>
        </div>
    );
