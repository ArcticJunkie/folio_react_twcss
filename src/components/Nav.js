    ...
    return (
        <div className="Nav text-gray-700">
            <nav className="bg-blue-50 flex flex-row items-center justify-between px-8 py-8 md:px-36 lg:px-52 md:py-8">
                <div className="font-bold font-dmono text-2xl hover:text-blue-700 mr-16 md:mr-52"><a href="#" className="">AV</a></div>
                <ul className="hidden md:flex flex-row justify-evenly space-x-12 font-dmono ">
